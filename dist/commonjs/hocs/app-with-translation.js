...
const appWithTranslation = function(WrappedComponent) {
    const WrappedComponentWithSSR = (0, _reacti18next.withSSR)()(WrappedComponent);
    ...
    class AppWithTranslation extends _react.default.Component {
            ...
            if (process.browser) {
                const changeLanguageCallback = (prevLng, newLng)=>{
                    ...
                    if (i18n.initializedLanguageOnce && typeof newLng === 'string' && prevLng !== newLng) {
                        const { as, href } = (0, _utils.lngPathCorrector)(config, {
                            as: asPath,
                            href: routeInfo
                        }, newLng);
      ...
      */ if (!process.browser && req && req.i18n) {
        ...
        */ const { fallbackLng } = config;
                const languagesToLoad = (0, _utils.lngsToLoad)(initialLanguage, fallbackLng, config.otherLanguages);
                /*
      ...
      */ return {
        ...
        render() {
            ...
            return /*#__PURE__*/ (0, _jsxruntime.jsx)(_reacti18next.I18nextProvider, {
                ...
                children: /*#__PURE__*/ (0, _jsxruntime.jsx)(_components.NextStaticProvider, {
                    children: /*#__PURE__*/ (0, _jsxruntime.jsx)(WrappedComponentWithSSR, {
