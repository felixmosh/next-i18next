    ...
    static async getInitialProps(ctx) {
      ...
      */
      if (!process.browser && req) {
        i18nServerInstance = req.i18n || i18n.cloneInstance({ initImmediate: false, initAsync: false })
        /*
      ...
      */
      if (!process.browser && req) {
        ...
        */
        initialI18nStore = Object.fromEntries(
          languagesToLoad.map((lng) => [
            lng,
            Object.fromEntries(
              namespacesRequired.map((ns) => [ns, (i18nServerInstance.services.resourceStore.data[lng] || {})[ns] || {}])
            ),
          ])
        );
